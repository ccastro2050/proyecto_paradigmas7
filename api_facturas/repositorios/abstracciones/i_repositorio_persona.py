"""
Contrato del repositorio de persona (v2) — el mismo Protocol de la v1,
...
class IRepositorioPersona(Protocol):
    """Las 5 operaciones de datos de la entidad persona."""
    ...
    async def obtener_por_codigo(self, codigo: str) -> dict | None:
        """La persona con ese codigo, o None si no existe."""
        ...
