"""
Repositorio de cliente para PostgreSQL — la capa de DATOS (v2).
...
class RepositorioClientePostgreSQL:
    """Implementación concreta de IRepositorioCliente contra PostgreSQL."""
