"""
Repositorio de persona para SQL Server — la capa de DATOS (v2).
...
class RepositorioPersonaSqlServer:
    """Implementación concreta de IRepositorioPersona contra SQL Server."""
    ...
    async def obtener_todos(self, limite: int) -> list[dict]:
        sql = text(
            "SELECT TOP (:limite) codigo, nombre, email, telefono "
