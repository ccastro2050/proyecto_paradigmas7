"""
Repositorio de vendedor para MariaDB — la capa de DATOS (v2).
...
class RepositorioVendedorMariaDB:
    """Implementación concreta de IRepositorioVendedor contra MariaDB."""
