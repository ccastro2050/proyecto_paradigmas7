"""
Contrato del servicio de cliente (v2). El controller depende de esta
...
class IServicioCliente(Protocol):
    """Las operaciones de negocio sobre cliente."""
    ...
    async def obtener(self, id_cliente: int) -> dict:
        """El cliente con ese id. LookupError si no existe."""
        ...
